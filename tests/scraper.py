...
class UpdateBot(object):
    ...
    def __init__(self, handle, headless=True):
        ...
        self.browser = webdriver.Chrome(options=options, executable_path='/home/ubuntu/chromedriver')  # export PATH=$PATH:/path/to/chromedriver/folder
    ...
    def update_user_dynamo(self):
        ...
        response = table.update_item(
            ...
            UpdateExpression="set twitter_name=:n, bio=:b, twitter_location=:l, website=:w, date_joined=:j",
